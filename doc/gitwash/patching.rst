...
Then, send the generated patch files to the `Clawpack
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `Clawpack mailing list`_.
...
Fork the Clawpack_ repository on github |emdash| :ref:`forking`.
Then::
