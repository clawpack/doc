...
# built documents.
#
# Get these from the branch currently checked out so conf.py doesn't
# have to change on different branches...

repo = git.Repo('..')
branch = str(repo.active_branch)
print('+++ Branch %s is checked out' % branch)
release = branch
version = os.path.splitext(release)[0]   # remove minor release # if present
print('+++ Setting version = %s,  release = %s' % (version,release))
