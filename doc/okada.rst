...
<https://www.clawpack.org/gallery/_static/apps/notebooks/geoclaw/Okada.html>`__
...
<https://www.clawpack.org/gallery/_static/apps/notebooks/geoclaw/dtopotools_examples.html>`__
gives some examples of using dtopotools to create a dtopofile using
the Okada model.

See also :ref:`dtopo` for more information on earthquake models and
formats supported for dtopofiles.
...
A kinematic rupture is **not** modeling the seismic
waves that would be generated by the specified subfault motions.
There are 3D seismic codes that do this, based on the same set of fault
