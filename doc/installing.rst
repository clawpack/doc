...
* `https://github.com/clawpack/clawpack/releases/download/v5.3.0/clawpack-5.3.0.tar.gz
  <https://github.com/clawpack/clawpack/releases/download/v5.3.0/clawpack-5.3.0.tar.gz>`_
* :ref:`previous`
* :ref:`changes`
...
clawpack tree to reside.  Then untar using the command::   
    ...
    tar -xzvf clawpack-5.3.0.tar.gz
