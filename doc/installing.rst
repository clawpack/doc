...
* `https://github.com/clawpack/clawpack/releases/download/v5.2.0/clawpack-5.2.0.tar.gz
  <https://github.com/clawpack/clawpack/releases/download/v5.2.0/clawpack-5.2.0.tar.gz>`_
...
clawpack tree to reside.  Then untar using the command::   
    ...
    tar -xzvf clawpack-5.2.0.tar.gz
