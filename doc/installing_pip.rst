...
or, more specifically, ::
    ...
    pip install --user clawpack==v5.8.1
...
want to change anything in this command)**::  
    ...
    pip install --src=$HOME/clawpack_src --user -e \
        git+https://github.com/clawpack/clawpack.git@v5.8.1#egg=clawpack-v5.8.1 \
...
- This will download Clawpack (via a git clone) into the directory
  `$HOME/clawpack_src/clawpack-v5.8.1`.  The top 
