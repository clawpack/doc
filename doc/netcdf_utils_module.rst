...
attribute parsing, coordinate convention detection, unit conversion, and
descriptor writing so that Fortran only needs to open the file and read
...
- :class:`~clawpack.geoclaw.netcdf_utils.MetInspector` — meteorological
  subclass; wind/pressure variable discovery, CF time decoding, unit
  conversion.
