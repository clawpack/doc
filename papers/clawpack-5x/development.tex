...
on all widely used platforms.  More importantly however is the ability to tag a
particular version of a repository with a digital object identifier (DOI) via a
...
The combination of these abilities address the issues of availability of
specific versions of the software and are citable in the scientific literature.}
