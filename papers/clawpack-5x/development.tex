...
\textit{downstream} projects. \comment{DAC : Do changes in visclaw really affect, for
example, amrclaw? Or Classic Claw?  Maybe call these utilities, core routines (upstream)
...
Can Clawpack also be installed using pip?  It sounds like only PyClaw can, although
we say Clawpack is available on PyPI. }
