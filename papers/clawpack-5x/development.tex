...
Sphinx\footnote{\url{http://sphinx-doc.org}},
    ...
    repositories.
\end{itemize}
The Clawpack 4.x code is also available in the
repository as
\begin{itemize}
...
The \texttt{clawpack} repository serves as an
...
Git submodules have proven to be very powerful and provide an invaluable
...
code, extending \clawpack with new Riemann solvers, algorithms, and
domain-specific problem tools.  Unfortunately, much of this code has not
