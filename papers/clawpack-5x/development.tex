...
\revised{The \texttt{clawpack} ``super-repository'' serves two purposes. First, it contains
...
the common Python packages numpy \revised{\cite{numpy}, \texttt{f2py} \cite{Peterson:2009tp}, matplotlib \cite{Hunter:2007}}, as well as
...
are to be used:
\begin{itemize}
    \item \revised{IPython/Jupyter if using the notebook interfaces \cite{ipython}.}
