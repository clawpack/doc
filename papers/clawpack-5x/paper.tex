...
\begin{abstract}
    \clawpack, a software package designed to solve nonlinear hyperbolic
    partial differential equations, has actively been developed for over 20
    years to date.  The newest major release, \clawpack 5, introduces a number
    of new features and changes to the code base and a new development model. 
    This article is meant as both a summary of these changes and the development
    approach as well as the rational behind some of the changes.
\end{abstract}
