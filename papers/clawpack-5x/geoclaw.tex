...
modified for \geoclaw. There are currently 113 files in the \amrclaw 2D library.
Twenty six of them are replaced by a \geoclaw-specific file of the same name
