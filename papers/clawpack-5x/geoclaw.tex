...
\geoclaw must also be well-
balanced - an ocean at rest should remain at rest. THis is necessary for 
waves with amplitudes that
...
source term using a splitting method. 
...
maximum flow depth at each point where hazard assesment is desired, 
maximum current
