...
complete description of the wave propagation algorithm but also is
notable in that the codes used to produce virtually all of figures
...
The extension to three space dimensions is similar. \comment{DAC : $(f,g) \cdot n$ is
diagonalizable?}
...
\comment{DAC : Does this fit here?} A variety of Riemann solvers have
been developed for \clawpack, many of which are collected in the
\texttt{riemann} repository, see \cref{sec:riemann}.
