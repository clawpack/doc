...
made by the many developers (listed here as authors) to the \clawpack code.
...
Some common examples included in the \clawpack sample equations are:
\begin{itemize}
...
problem}, which consists of equations \cref{eq:hyp1a} or
...
\ignore{In practice, approximate Riemann solvers are commonly used for
nonlinear problems.}
%, which replace rarefaction waves by one or more discontinuities.
