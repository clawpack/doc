...
Version 5 of \clawpack introduces both user facing features and a number of
...
investigate \footnote{\url{http://amroc.sourceforge.net/}}{AMROC}, 
\footnote{\url{https://ccse.lbl.gov/BoxLib/index.html}}{BoxLib}, Chombo \cite{chombo},
Gerris \cite{gerris}, \footnote{\url{http://cfd.direct/openfoam/download/}}{OpenFOAM}, 
