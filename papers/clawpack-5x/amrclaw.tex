...
version of this example, and ran it on a 40 core Intel Xeon Haswell machine.
...
Several snapshots of the solution are shown in the \cref{fig:shockbubble}, 
to illustrate how localized the phenomena needing refinement is. 

\begin{figure}[h]
    \centering
    %\includegraphics[width=0.45\textwidth]{amr_scaling}
    \includegraphics[width=0.45\textwidth]{cpuTime.png}
    \includegraphics[width=0.45\textwidth]{efficiency.png}
    \caption{Left is strong scaling results for an \amrclaw example demonstrating a
    shock-bubble interaction in the Euler equations of compressible
    gas-dynamics. Right is plot of efficency based on total computational time.}
