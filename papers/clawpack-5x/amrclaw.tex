...
\begin{figure}[tb]
    \centering
    \includegraphics[width=\textwidth]{./figures/shockbubble_grids.png}
    \caption{\revised{An illustration of grid and cell layout for an
    axis-symmetric Euler gas bubble problem.  The illustration shows cells on
    levels up to level 2 and grids on finer levels.}}
    \label{fig:figure1}
\end{figure}
