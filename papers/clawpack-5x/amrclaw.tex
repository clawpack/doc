...
useful for constraining refinement, e.g. tsunami arrival at the shore.  
...
The 3D \amrclaw code had been reintroduced in 5.0.  \amrclaw has also been parallelized using OpenMP directives based on grid patch-based decomposition.  
